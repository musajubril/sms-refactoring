        ...
        <div className="flex-col flex gap-[6px]">
            ...
            <div className="absolute inset-y-0 right-[16px] flex items-center pl-3 pointer-events-none">
              <Icon className="w-5 h-5 text-[#8F90A6]" />
                ...
                <input type={type} required={required} onChange={change} id={id} value={value} placeholder={placeholder} className='px-4 py-[10px] h-10 rounded-[4px] border border-[#C7C9D9] placeholder-[#555770] w-full disabled:bg-[#F5F6F8] ' />
            </div>
