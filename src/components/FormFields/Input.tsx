    ...
    <div>
        <div className="flex-col flex gap-[6px]">
            ...
            <div className="h-10 relative">
                <input type={type} required={required} onChange={change} id={id} value={value} placeholder={placeholder} className='px-4 py-[10px] h-10 rounded-[4px] border border-[#C7C9D9] placeholder-[#555770] w-full ' disabled={disabled} />
            </div>
