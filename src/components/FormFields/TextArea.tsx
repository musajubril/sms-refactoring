...
import { TextAreaType } from '../../Interfaces/Input';
    ...
    <div>
        <div className="flex-col flex gap-[6px]">
            ...
            <div className="relative">
                <textarea required={required} rows={3} id={id} value={value} onChange={change} placeholder={placeholder} className='px-4 py-[10px] rounded-[4px] border border-[#C7C9D9] placeholder-[#555770] w-full disabled:bg-[#F5F6F8] ' disabled={disabled} />
            </div>
